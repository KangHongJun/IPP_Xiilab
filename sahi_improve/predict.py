...
def get_sliced_prediction(
    ...
    #print(postprocess_constructor,"postprocess_constructor-------")
...
def predict(
    ...
    for ind, image_path in enumerate(
        ...
        if not no_sliced_prediction:
            ...
            print("이거 돕니까?")
            print("prediction_result-----no_predict",prediction_result)
...
# overlap_height_ratio=0,overlap_width_ratio=0 옵션을 주면 잘리는 구간이 달라지는 만큼 밀린다
...
# predict(model_path="model/yolov5m.pt",
#             model_type="yolov5",
#             source="demo_data/people/people9.jpg",
#             slice_height=640,  # 고정
#             slice_width=640,  # 고정
#             postprocess_type="NMS",
#             postprocess_match_metric="IOS",
